...
//
// Descrição:	Nível 2 do jogo Breakout
//
**********************************************************************************/
...
void Level2::Init() {
	...
	backg = new Sprite("Resources/bg2.png");
	infobar = new Sprite("Resources/infobar2.png");
	...
	fin.close();
	Game::stats.totalBricks[1] = totalBricks;
}
...
void Level2::Update()
{
	...
	else
	{
		...
		ball->invX = false;
		ball->invY = false;
		Game::stats.score[1] = player->score;
		anim3s->NextFrame();
		...
		else if (Game::stats.bricksDestroyed >= Game::stats.totalBricks[0] + Game::stats.totalBricks[1]) {
			Engine::Next<Level3>();
		}
	}
}
