...
// grupo dos objetos da cena
enum ObjectGroup
{
	STATIC,										// objetos desse grupo não colidem entre si
	MOVING										// podem colidir entre si e com os estáticos
};

// definição tipos para pares de elementos
typedef pair<Object*, Object*>  ObjectPair;		// par de objetos em colisão
typedef pair<Object*, int>      ObjectDel;		// <objeto,tipo> a deletar da cena
